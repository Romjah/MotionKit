"use strict";
(self["webpackChunkmotion_kit"] = self["webpackChunkmotion_kit"] || []).push([["animations-Notification-stories"],{

/***/ "./src/animations/Notification.stories.jsx":
/*!*************************************************!*\
  !*** ./src/animations/Notification.stories.jsx ***!
  \*************************************************/
...
/* harmony import */ var _notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notifications */ "./src/animations/notifications.ts");
...
var NotificationDemo = function NotificationDemo(props) {
  var _ref = props || {},
    _ref$options = _ref.options,
    options = _ref$options === void 0 ? {} : _ref$options,
    _ref$message = _ref.message,
    message = _ref$message === void 0 ? 'This is a notification' : _ref$message;
  var notificationRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    // Créer la notification dans le body
    var container = document.createElement('div');
    document.body.appendChild(container);
    notificationRef.current = new _notifications__WEBPACK_IMPORTED_MODULE_1__.Notification(container, options);
...
var Success = {
  render: function render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NotificationDemo, {
      options: {
        type: 'success',
        position: 'top-right'
      },
...
;
const __namedExportsOrder = ["Success", "Error", "Warning", "Info", "TopLeft", "BottomRight", "BottomLeft", "TopCenter", "BottomCenter"];
Success.parameters = {
  ...Success.parameters,
  docs: {
    ...Success.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'success',\n    position: 'top-right'\n  }} message=\"Operation completed successfully!\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification de succ\xE8s (verte) affich\xE9e en haut \xE0 droite, id\xE9ale pour confirmer une action r\xE9ussie.\"\n      }\n    }\n  }\n}",
...
Error.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'error',\n    position: 'top-right'\n  }} message=\"An error occurred. Please try again.\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'erreur (rouge) affich\xE9e en haut \xE0 droite, pour signaler un probl\xE8me ou une action \xE9chou\xE9e.\"\n      }\n    }\n  }\n}",
...
Warning.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'warning',\n    position: 'top-right'\n  }} message=\"Please review your changes before proceeding.\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'avertissement (orange) affich\xE9e en haut \xE0 droite, pour attirer l'attention sur une action \xE0 valider.\"\n      }\n    }\n  }\n}",
...
Info.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'top-right'\n  }} message=\"New updates are available.\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information (bleue) affich\xE9e en haut \xE0 droite, pour informer l'utilisateur d'une nouveaut\xE9 ou d'un message neutre.\"\n      }\n    }\n  }\n}",
...
TopLeft.parameters = {
  ...TopLeft.parameters,
  docs: {
    ...TopLeft.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'top-left'\n  }} message=\"Notification in top-left corner\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information affich\xE9e en haut \xE0 gauche de l'\xE9cran.\"\n      }\n    }\n  }\n}",
      ...TopLeft.parameters?.docs?.source
    }
  }
};
BottomRight.parameters = {
  ...BottomRight.parameters,
  docs: {
    ...BottomRight.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'bottom-right'\n  }} message=\"Notification in bottom-right corner\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information affich\xE9e en bas \xE0 droite de l'\xE9cran.\"\n      }\n    }\n  }\n}",
      ...BottomRight.parameters?.docs?.source
    }
  }
};
BottomLeft.parameters = {
  ...BottomLeft.parameters,
  docs: {
    ...BottomLeft.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'bottom-left'\n  }} message=\"Notification in bottom-left corner\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information affich\xE9e en bas \xE0 gauche de l'\xE9cran.\"\n      }\n    }\n  }\n}",
      ...BottomLeft.parameters?.docs?.source
    }
  }
};
TopCenter.parameters = {
  ...TopCenter.parameters,
  docs: {
    ...TopCenter.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'top-center'\n  }} message=\"Notification in top-center\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information affich\xE9e en haut au centre de l'\xE9cran.\"\n      }\n    }\n  }\n}",
      ...TopCenter.parameters?.docs?.source
    }
  }
};
BottomCenter.parameters = {
  ...BottomCenter.parameters,
  docs: {
    ...BottomCenter.parameters?.docs,
    source: {
      originalSource: "{\n  render: () => <NotificationDemo options={{\n    type: 'info',\n    position: 'bottom-center'\n  }} message=\"Notification in bottom-center\" />,\n  parameters: {\n    docs: {\n      description: {\n        story: \"Notification d'information affich\xE9e en bas au centre de l'\xE9cran.\"\n      }\n    }\n  }\n}",
      ...BottomCenter.parameters?.docs?.source
    }
  }
};
...
/***/ "./src/animations/notifications.ts":
/*!*****************************************!*\
  !*** ./src/animations/notifications.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Notification = /*#__PURE__*/function () {
  ...
  return _createClass(Notification, [{
    ...
    value: function getTypeStyles() {
      ...
      return _objectSpread(_objectSpread({}, baseStyles), typeStyles[this.options.type || 'info']);
    }
  }, {
    key: "show",
...
//# sourceMappingURL=animations-Notification-stories.iframe.bundle.js.map